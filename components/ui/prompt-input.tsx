...
import { Select, SelectItem } from "@/components/ui/select-prompt";
      ...
      {mediaType === "image" ? (
        ...
        <div className="text-muted-foreground flex size-full max-w-full cursor-pointer items-center justify-start gap-2 overflow-hidden px-2">
          ...
          <TooltipTrigger delay={400}>
            <Button variant="ghost" className="min-w-0 flex-1 justify-start p-0 h-auto hover:bg-transparent">
...
export const PromptInput = ({
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = (event) => {
    ...
    if (!usingProvider && !disableResetOnSubmit) {
      form.reset();
    }
